...
import 'package:head_hunter/view/bottom/seeker-account-view.dart';
import 'package:head_hunter/view/furc.dart';
    ...
    return  Scaffold(
      ...
      body: SafeArea(
        ...
        children: [
          ...
          20.height,
         FutureBuilder(
             future: UserServices.fetchUserData(FirebaseAuth.instance.currentUser!.uid),
           ...
           return   Row(
             children: [
               ...
               Column(
                 crossAxisAlignment: CrossAxisAlignment.start,
                 children: [
                   MyText(text: capitalizeEachWord(data.userName),fontWeight: FontWeight.w600,size: 16.sp,),
                   2.height,
          ...
          30.height,
           ProfileWidget(title: "FURC", iconUrl: AppAssets.furcIcon,onPressed: (){
             Navigator.push(context, MaterialPageRoute(builder: (context)=>UniversityInfoPage()));
           },),
           ProfileWidget(title: "Account", iconUrl: AppAssets.accountIcon,onPressed: (){
             Navigator.push(context, MaterialPageRoute(builder: (context)=>const SeekerAccountView()));
           },),
