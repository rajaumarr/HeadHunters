...
class JobDetailView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(child: SymmetricPadding(child: SingleChildScrollView(
        child: FutureBuilder(
          ...
          return Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  children: [
                    20.height,
                   FutureBuilder(
                       future: CompanyServices.fetchCompanyData(data.companyId),
              ...
              20.height,
              MyText(text: "Job Description",fontWeight: FontWeight.w600,size: 16.sp,color: primaryColor,),
              5.height,
              const Divider(),
              5.height,
              MyText(text: '''${data.jobDescription.toString()}''',size: 14.sp,fontWeight: FontWeight.w400,
                fontFamily: AppFonts.poppins,color: primaryColor,lineHeight: 2,),
              20.height,
              MyText(text: "Required Skills",fontWeight: FontWeight.w600,size: 16.sp,color: primaryColor,),
              5.height,
              const Divider(),
              5.height,
              // Wrap(
                ...
                showDialog(context: context, builder: (context){
                  return  Dialog(
                    ...
                    child: ConfirmationDialog(
                      onPressed: (){
                        Navigator.pushNamed(context, RoutesNames.applyJobView,arguments: jobId);
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        10.height,
        Text("Are you sure to apply?",style: GoogleFonts.kronaOne(
          fontSize: 18.sp,
          color: primaryColor,
          fontWeight: FontWeight.w400
        ),),
