...
class JobApplicantsView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
     List<Map<String,dynamic>>applicantsIds=ModalRoute.of(context)!.settings.arguments as List<Map<String,dynamic>>;
      ...
      body: SafeArea(
        child: SymmetricPadding(
          child: Column(
            children: [
              20.height,
               TopWidget(title: "Applications",onPressed: (){Navigator.pop(context);},),
              20.height,
              applicantsIds.isEmpty?

                  SizedBox(
                      height: 500.h,
                      child: Center(child: MyText(text: "Not found any Applicants"))):
              Expanded(
                child: ListView.builder(
                  ...
                  return FutureBuilder(
                      future: UserServices.fetchUserData(applicantId['userId']),
                    ...
                    return Container(
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Image.asset(AppAssets.furcIcon,scale: 3,),
                            10.width,
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                MyText(text: capitalizeEachWord(applicantData!.userName),color: primaryColor,size: 14.sp,),
                                5.height,
                                MyText(text: applicantData.email,color: const Color(0xff858BBD),size: 12.sp,),
                                5.height,
                                Container(
                                  width: 85.w,
                                  height: 24.h,
                            ...
                            Padding(
                              ...
                              child: GestureDetector(
                                  onTap: (){
                                    JobServices.downloadAndSaveFile(applicantsIds[index]['cvUrl'], applicantData.userName);
                                  },
                                  child: Image.asset(AppAssets.downloadIcon,scale: 3,)),
                            )
                          ],
                        ),
                      ),
